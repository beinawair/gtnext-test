import { createStringUnionType, modelFactory } from "@commons/index"
...
export const { getValidValue: getPaymentMethodStatusOption } =
  createStringUnionType(PaymentMethodStatus)
...
export const { getValidValue: getPaymentMethodTypeOption } =
  createStringUnionType(PaymentMethodType)
...
export type PaymentMethodVA = PaymentMethod<VirtualAccountDetail>
export type PaymentMethodCrypto = PaymentMethod<CryptoDetail>
