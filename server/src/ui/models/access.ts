...
import { TransactionTokenPayload } from "@server/core/domain/merchant_transaction/models/transaction_token"
...
export class AccessMerchantPrincipal extends BaseAccessPrincipal {
  constructor(
    public id: string,
    public name?: string,
    public key?: string,
...
export class AccessTransactionalPrincipal extends TransactionTokenPayload {
  public isAuthenticated(): this is Required<AccessTransactionalPrincipal> {
    return Boolean(
      !isEmpty(this.transaction_id)
      && !isEmpty(this.merchant_id),
    )
  }
...
export class AccessPrincipal {
  constructor(
    ...
    public merchant?: AccessMerchantPrincipal,
